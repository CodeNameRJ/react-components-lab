import './App.css'
import WeatherForecast from './component/WeatherForecast/WeatherForecasts';
  ...
  return (
    ...
    <section>
      ...
      {weatherForecasts.map((forecast, index) => {
        console.log(`rendering forecast ${index + 1}:`, forecast)
        return <WeatherForecast key={index}{...forecast} />
      })
      }
